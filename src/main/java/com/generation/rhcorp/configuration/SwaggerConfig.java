...
public class SwaggerConfig {
    ...
    OpenAPI springBlogPessoalOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Projeto Integrador - RH Corp")
                        .description("Projeto Integrador - Projeto de Gerenciamento de RH feito pelo grupo 5")
                        .version("v0.0.1")
                        .license(new License()
                                .name("JavaSon's Five")
                                .url("https://github.com/Aplicativo-Sistema-de-RH/Aplicativo_Sistema_RH?tab=readme-ov-file#descri%C3%A7%C3%A3o-do-projeto"))
                        .contact(new Contact()
                                .name("JavaSon's Five")
                                .url("https://github.com/Aplicativo-Sistema-de-RH/Aplicativo_Sistema_RH?tab=readme-ov-file#descri%C3%A7%C3%A3o-do-projeto")
                                .email("grupo_5_generation@proton.me")))
                .externalDocs(new ExternalDocumentation()
                        .description("JavaSon's Five")
                        .url("https://github.com/Aplicativo-Sistema-de-RH/Aplicativo_Sistema_RH?tab=readme-ov-file#descri%C3%A7%C3%A3o-do-projeto"));
    }
